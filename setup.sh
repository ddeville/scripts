...
sublime_text_settings_location="$HOME/Library/Application Support/Sublime Text 3/Packages/User"
mkdir "${sublime_text_settings_location}" > /dev/null 2>&1

link_file "${themes_origin_folder}/sublime-text/Preferences.sublime-settings" "${sublime_text_settings_location}/Preferences.sublime-settings"
link_file "${themes_origin_folder}/sublime-text/Default (OSX).sublime-keymap" "${sublime_text_settings_location}/Default (OSX).sublime-keymap"
